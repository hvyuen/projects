...
class Rotor {
     ...
     *  to advance. */
    boolean atNotch() {
        return notches().indexOf(alphabet().toChar(
                permutation().wrap(setting() + _ringSetting))) > -1;
    }
    ...
    void setRing(int ringSetting) {
        ...
        _setting -= permutation().wrap(ringSetting);
    }
    ...
    /** Setting that the rotor is at. */
    private int _setting;

    /** Ring setting that the rotor is at. */
